...
export class HeatmapComponent implements OnInit {
  diags = ['Clients', 'BMIDs', 'BMID failed', 'Flags passed'];
  managerX: string[] = [];
  managerY: string[] = [];
...
{x: 'Edinburgh', y: 'G', value: 26.000000 }
  ...
  ngOnInit() {
    ...
    } else if (this.chosenData === this.diags[2]) {
    this.managerProcess(this.managerData2);
  } else if (this.chosenData === this.diags[3]) {
    this.managerProcess(this.managerData3);
  }
