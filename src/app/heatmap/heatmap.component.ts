...
export class HeatmapComponent implements OnInit, DatamoduleModule {
  diags: string[];
  managerData0: { x: string; y: string; value: number; }[];
  managerData1: { x: string; y: string; value: number; }[];
  managerData2: { x: string; y: string; value: number; }[];
  managerData3: { x: string; y: string; value: number; }[];
  managerData4: { x: string; y: string; value: number; }[];
  managerData5: { x: string; y: string; value: number; }[];
  managerData6: { x: string; y: string; value: number; }[];
  managerData7: { x: string; y: string; value: number; }[];
  managerData8: { x: string; y: string; value: number; }[];
  managerData9: { x: string; y: string; value: number; }[];
  managerData10: { x: string; y: string; value: number; }[];
  managerData11: { x: string; y: string; value: number; }[];
  managerData12: { x: string; y: string; value: number; }[];
  managerData13: { x: string; y: string; value: number; }[];
  managerData14: { x: string; y: string; value: number; }[];
  managerData15: { x: string; y: string; value: number; }[];
  managerData16: { x: string; y: string; value: number; }[];
  managerData17: { x: string; y: string; value: number; }[];
  managerData18: { x: string; y: string; value: number; }[];
  managerData19: { x: string; y: string; value: number; }[];
  managerData20: { x: string; y: string; value: number; }[];
  managerData21: { x: string; y: string; value: number; }[];
  managerData22: { x: string; y: string; value: number; }[];
  managerData23: { x: string; y: string; value: number; }[];
  managerData24: { x: string; y: string; value: number; }[];
  managerData25: { x: string; y: string; value: number; }[];
  managerData26: { x: string; y: string; value: number; }[];
